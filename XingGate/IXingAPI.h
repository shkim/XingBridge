...
public:
	...
	// 조회성TR 관련
	inline	int		Request					( HWND hWnd, LPCTSTR pszCode, LPVOID lpData, int nDataSize, BOOL bNext=FALSE, LPCTSTR pszNextKey=_T(""), int nTimeOut=30 );
...
BOOL IXingAPI::LoadLibHelper( LPCTSTR szPath )
{
	...
	{
		_stprintf_s( szCommLib, MAX_PATH, _T( "%s\\XingAPI.dll" ), szPath );
	}
